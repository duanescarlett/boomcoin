...
echo 'alias boom="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/guitartool/boomcoin" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/guitartool/boomcoin'"
...
rm -rf "$HOME/.config/@boom"
rm -rf "$HOME/.config/@boom"
rm -rf "$HOME/.config/boom-core"
